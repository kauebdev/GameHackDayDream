...
if (spawn_timer >= spawn_interval) 
{
    ...
    if (instance_number(obj_inimigo2) < max_inimigos) 
    {
        ...
        if (!place_meeting(_spawn_x + 2, _spawn_y + 2, obj_colision) && global.kills <= 5) 
        {
            // Cria o inimigo
            instance_create_layer(_spawn_x + 4, _spawn_y + 4, "inimigos", obj_inimigo2);
        }
    }
